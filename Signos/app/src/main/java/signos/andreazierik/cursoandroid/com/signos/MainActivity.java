package signos.andreazierik.cursoandroid.com.signos;
...
public class MainActivity extends Activity {
    ...
    private String[] signos = {
            "Áries", "Leão", "Sagitário", "Touro", "Virgem",
            "Capricórnio", "Gêmeos", "Libra", "Aquário",
            "Câncer", "Escorpião", "Peixes"
    };

    private String[] perfis = {
            "Arianos são animados, independentes, individuais, dinâmicos, corajosos e aventureiros",
